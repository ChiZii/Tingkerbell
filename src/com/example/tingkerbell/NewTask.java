...
import com.example.tingkerbell.DBAdapter;
...
public class NewTask extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDesc = (EditText) findViewById(R.id.txtTask);
		mAdd = (Button) findViewById(R.id.btnAdd);
		mRowId = (savedInstanceState == null) ? null
				: (Long) savedInstanceState
						.getSerializable(DBAdapter.KEY_ROW_ID);
		if (mRowId == null) {
	...
	private void populateFields() {
		if (mRowId != null) {
			...
			mTask.setText(c.getString(c
					.getColumnIndexOrThrow(DBAdapter.KEY_TASK)));
			mDesc.setText(c.getString(c
